...
export const addTests: TestDefinition[] = [
	{
		...
		fn: async (db: ValtheraClass) => {
			...
			if (typeof doc._id !== "string")
				throw new Error("Auto-generated _id should be a string");
	...
	},
	{
		...
		fn: async (db: ValtheraClass) => {
			...
			if (doc._id !== undefined)
				throw new Error("Document should not have _id when id_gen: false");
		},
	},
	{
		domain: "crud-add",
		...
		fn: async (db: ValtheraClass) => {
			...
			if (doc._id !== "custom-id")
				throw new Error("Document should have manual _id");
		},
	},
	...
	// === 4. Basic CRUD - Read ===
	{
		...
		fn: async (db: ValtheraClass) => {
			...
			if (results.length !== 2)
				throw new Error("Expected 2 documents, got: " + results.length);
		},
	},
	{
		domain: "crud-read",
